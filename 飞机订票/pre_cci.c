# 1 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c"
...
# 1 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c" 2
...
# 2 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c" 2
...
{   
	...
	web_reg_find("TextPfx=Welcome, <b>",    
		"TextSfx=</b>",     
		"Fail=NotFound",    
		"SaveCount=check",  
		"Search=Body",      
...
# 3 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c" 2
...
Action()
{
	...
	if(atoi(lr_eval_string("{check_2}"))>0){
		...
		lr_end_transaction("第二步选择订票信息", 0);

	}
	else{
		lr_end_transaction("第二步选择订票信息", 1);
		return 0;
	}
	...
	if(atoi(lr_eval_string("{check_3}"))>0){
		...
		lr_end_transaction("第三步选择起飞时间", 0);

	}
	else{
		lr_end_transaction("第三步选择起飞时间", 1);
		return 0;
	}
	...
	lr_end_transaction("第四步提交乘客信息", 0);
	}
    else{
	lr_end_transaction("第四步提交乘客信息", 1);
	}
...
# 4 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c" 2
...
# 5 "c:\\users\\vidya\\desktop\\\267\311\273\372\266\251\306\261\\\\combined_\267\311\273\372\266\251\306\261.c" 2
